...
| 15 | EN_REVISION | Cobertura técnica contrastada con Microsoft; título principal y estado visible normalizados; retirados los metadatos internos; banco con 12 preguntas trazables | Validar enlaces de los cinco bloques, `fuentes.md`, `feedback.md` y `aprobacion.md`; comprobar esquema final y llamadas destacadas |
