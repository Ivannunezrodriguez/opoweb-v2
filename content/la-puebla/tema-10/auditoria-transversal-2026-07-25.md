...
Se han revisado conjuntamente:

- `manual.md`;
- `matriz.json`;
- `preguntas.json`;
- texto consolidado oficial del Real Decreto Legislativo 2/2004, de 5 de marzo;
- texto consolidado oficial de la Ley 58/2003, de 17 de diciembre, General Tributaria.

## Resultado jurídico

La cobertura es coherente con el epígrafe oficial:

- principios constitucionales y legales de tributación local;
- delegación y colaboración de los artículos 7 y 8 TRLRHL;
- beneficios fiscales, compensación y aplicación local de la normativa tributaria general;
